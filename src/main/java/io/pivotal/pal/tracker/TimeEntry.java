...
public class TimeEntry {
	...
	public TimeEntry(long timeEntryidVal, long projectIdVal, long userIdVal, LocalDate dateVal, int hourVal) {
		this.id = timeEntryidVal;
	...
	public TimeEntry(long projectIdVal, long userIdVal, LocalDate dateVal, int hourVal) {
		this.projectId = projectIdVal;
		this.userId = userIdVal;
		this.date = dateVal;
		this.hours = hourVal;
